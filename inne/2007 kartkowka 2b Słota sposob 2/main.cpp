...
#include <ctime>
/*
 dana jest 2-wymiarowa tablica integer, znajdz element dla którego suma elementów lezacych na
przekatnych na których przecieciu znajduje sie nasz element jest najwieksza
*/
using namespace std;
const int N = 3;
